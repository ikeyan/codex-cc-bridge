...
const probedFields = {
	args: z.array(z.string()).optional().describe("Arguments for these binaries, instead of defaultArgs"),
	ifFail: z.lazy(() => z.array(binFindStrategyItemSchema)).optional().describe("Strategies to use instead when the binary is found but does not answer an LSP initialize request with these args")
};
...
const binFindStrategyItemSchema = z.lazy(() => z.discriminatedUnion("type", [
	venvItemSchema,
