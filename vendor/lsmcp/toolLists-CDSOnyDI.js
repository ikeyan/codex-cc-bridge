...
const probedFields = {
	...
	ifFail: z.lazy(() => z.array(binFindStrategyItemSchema)).optional().describe("Strategies to try instead when the binary is found but fails to start as a language server with these args")
};
